...
| 平台 | 接口数 | 核心能力 |
|------|:------:|---------|
| **抖音** | **247** | 视频详情 · 用户画像 · 作品列表 · 评论/回复 · 热搜榜 · 品牌热榜 · 音乐榜 · 直播热搜 · 直播间弹幕 · 商品详情/SKU/评价/优惠券 · 话题详情/作品 · 短剧 · 视频弹幕 · 搜索(综合/视频/用户/话题/直播/音乐/商品) · 粉丝列表 · 关注列表 · 喜欢列表 · 收藏夹 · 创作者数据 · 星图达人数据 · 批量视频 · 高清下载链接 · 短链生成 · 二维码生成 |
| **小红书** | **68** | 笔记详情 · 用户信息 · 作品列表 · 评论 · 搜索(笔记/用户/商品) · 热搜 · 话题 · 收藏 · 粉丝/关注 · 商品详情 |
| **B站** | **41** | 视频详情 · UP主信息 · 投稿列表 · 评论/回复 · 弹幕 · 热搜 · 搜索 · 排行榜 · 直播 · 专栏 · 番剧 |
| **快手** | **33** | 视频详情 · 用户信息 · 作品列表 · 评论 · 搜索 · 热搜 · 直播 · 话题 |
| **微博** | **64** | 微博详情 · 用户信息 · 微博列表 · 评论/转发 · 热搜 · 搜索(综合/用户/话题) · 超话 · 粉丝/关注 |
| **微信视频号** | **9** | 视频详情 · 用户信息 · 作品列表 · 评论 · 搜索 |
| **微信公众号** | **10** | 文章详情 · 公众号信息 · 文章列表 · 评论 · 搜索 |
| **知乎** | **32** | 回答详情 · 用户信息 · 回答列表 · 评论 · 搜索 · 热榜 · 专栏 · 想法 |
| **西瓜视频** | **7** | 视频详情 · 用户信息 · 作品列表 · 评论 |
| **头条** | **7** | 文章详情 · 用户信息 · 搜索 |
| **皮皮虾** | **17** | 视频详情 · 用户信息 · 作品列表 · 评论 · 搜索 · 热门 |

### 🌏 海外平台

| 平台 | 接口数 | 核心能力 |
|------|:------:|---------|
| **TikTok** | **204** | 视频详情 · 用户画像 · 作品列表 · 评论/回复 · 热搜 · 搜索(视频/用户/话题/直播/音乐/商品) · 话题/挑战 · 音乐 · 直播 · 粉丝/关注 · 喜欢列表 · 广告数据(广告主/素材/趋势) · 创作者数据 · 互动功能 · TikTok Shop(商品/评价/店铺) · 批量视频 · 高清下载 |
| **YouTube** | **37** | 视频详情 · 频道信息 · 视频列表 · 评论/回复 · 搜索 · 字幕提取 · 播放列表 · Shorts · 社区帖子 · 热门视频 |
| **Instagram** | **83** | 帖子详情 · 用户信息 · 帖子列表 · 评论 · 搜索 · Stories · Reels · 话题 · 粉丝/关注 · 位置搜索 · 标签 · IGTV |
| **Twitter/X** | **13** | 推文详情 · 用户信息 · 推文列表 · 搜索 · 趋势 · 粉丝/关注 · 回复 |
| **Threads** | **11** | 帖子详情 · 用户信息 · 帖子列表 · 评论 · 搜索 |
| **Reddit** | **24** | 帖子详情 · 用户信息 · 帖子列表 · 评论 · 搜索 · Subreddit · 热门 |
| **LinkedIn** | **25** | 个人档案 · 公司信息 · 帖子 · 评论 · 搜索(人/公司/职位) · 工作机会 |
| **Lemon8** | **16** | 帖子详情 · 用户信息 · 作品列表 · 评论 · 搜索 |

### 🔧 特殊能力

| 能力 | 说明 |
|------|------|
| **混合解析** | 粘贴任意平台链接，自动识别平台 + 提取数据 |
| **批量操作** | 一次最多处理 50 个视频/用户 |
| **高清下载** | 获取无水印最高画质视频下载链接 |
| **直播数据** | 弹幕、礼物排行、商品、在线人数 |
| **电商数据** | 抖音/TikTok 商品详情、SKU、评价、优惠券 |
| **广告情报** | TikTok 广告主、广告素材、投放趋势 |
| **创作者后台** | 抖音/TikTok 创作者数据、星图达人数据 |
